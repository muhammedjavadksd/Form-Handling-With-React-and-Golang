...
import { TError } from './subComponents/Toastify';
...
const ResumeInput = () => {
  ...
  const handleRegisterSubmit = async (event) => {
    ...
    try {
      TError("Provide valid API endpoint")
  ...
  const inputs = [
    {
      ...
      type: "text",
      inputmeta: null,
      wrapperclass: "flex flex-col mb-3",
      name: "fullname",
...

    {
      ...
      name: "address",
      inputmeta: { type: "textArea", rows: "4" },
      className: "px-3 py-2 bg-gray-800 border border-gray-900 focus:border-red-500 focus:outline-none focus:bg-gray-800 focus:text-red-500",
      wrapperclass: "flex flex-col mb-3",
      labelclass: "block text-sm font-medium text-gray-400",
      error:
  ...
  return (
    <>
      <section id="contact" className="relative w-full min-h-screen flex justify-center items-center bg-black text-red-500">
        {/* // component */}
        ...
        {/* wrapper */}
        <div className="relative p-5 lg:px-20 w-full md:w-2/5 flex flex-col md:flex-row items-center justify-center">
          ...
          {/* Contact Me */}
          <div className='one-div w-full h-full flex  justify-center items-center '>
            <span className='absolute p-4 font-bold tracking-wide text-3xl uppercase'>Register now</span>
            <div className="text w-full
             h-full">
              <form onSubmit={handleRegisterSubmit} className="w-full  border border-red-500 p-6 bg-gray-900">
